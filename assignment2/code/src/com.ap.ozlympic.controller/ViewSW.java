...
package com.ap.ass2.controller;
...
public class ViewSW implements Initializable {
	...
	try{
	String sql="select * from Participant where Type like 'swimmer' or Type like 'super';";
